...
<!-- header part end -->
        ...
        <section class="inner-banner">
            <div class="container">
                <div class="inner-banner__content-wrap">
                    <h2 class="text-light">SEO/SMO Analysis Services</h2>
                    <p>Our comprehensive Search Engine Optimization (SEO) audit is the fastest, most efficient way to analyze your site's technical, on-page and off-page SEO.</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 justify-content-center align-items-start">
                        <h2><strong>Get the Best SEO/SMO Audit Services Without Any Hassle </strong></h2>
                            <p>
                    ...
                    <div class="col-md-5">
                        <div class="SEO_audit">
                            <h3>SEO/SMO AUDIT</h3>
                            <p>All Websites, Web Apps &amp; blogs</p>
                            <ul>
                                <li>Increase your Traffic in 90 Days</li>
                                <li>Done by Experienced Experts</li>
                                <li>TAT within 24 hours</li>
                                <li>Complete Strategies</li>
                                <li>Customized Action Plan</li>
                                <li>Dedicated <strong>Consulting</strong></li>
                            </ul>
                ...
                <div class="row pading">
                    ...
                    <div class="col-md-6">
                        <div class="why_right_content">
                            <ul>
                                <li>To optimise your Traffic in Just 90 Days</li>
                                <li>To increase visiblity in Google &amp; Other Search Engines</li>
                                <li>Enhanced user Experience hence Increased Conversions</li>
                                <li>To understand the condition of your web On-Page</li>
                                <li>Get Specific recommendations for profile building</li>
                                <li>Content Optimization Tips</li>
                                <li>Aware you on How to avoid Google Penalties</li>
                                <li>Get your Customized Action Plan – just for your Website</li>
                                <li>100+ checks covering all areas</li>
                                <li>Implementation Services (Optional)</li>
                                <li>To get More Targeted Keyword Suggestions</li>
            ...
            <div class="container">
                <div class="text-center">
                    <h2 class="short word-rotator-title font_size_heding">
                        OUR SEO/SMO AUDITING PROCESS
                        <div class="sub_heading">
                            <p>Monitor a website's analytics and keyword rankings more frequently to stay competitive.</p>
                        </div>
    
                    </h2>
                    <p>
                        As search engines focus more on providing relevant content, we have enhanced our on-page SEO audits to ensure that our client's targeted pages are worthy of ranking.
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="how_it_work1">
                            <h2>Why Should I Get Audit Review?</h2>
    
                            <ul>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> How To Optimize Your Traffic In Just 90 Days</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> To increase visibility in Google and other search engines</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Enhanced user experience hence increased conversions</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> To understand the status of your web on-page</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Get specific recommendations for profile creation</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Content Optimization Tips</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Taught you how to avoid a Google penalty</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Get your customized action plan - just for your website</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> 100+ checks covering all sectors</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Implementation Services (Optional)</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> To get more targeted keyword suggestions</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="what_included_section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="what_included_heding text-center">
                            <h2>Factors Considered When Conducting a Website Audit</h2>
                            <p ><h5 ><i class="fa fa-hand-o-right text-primary" ></i> SEO audit is performed to analyze the performance of a website in comparison to best practices. The objective is to detect issues that may affect the performance of organic search.</h5></p>
                        </div>
                    </div>
                </div>
                <div class="row">
        ...
        <section class="service_web_section benefits">
            <div class="container">
                <div class="row web_margin_top text-center">
                    <div class="col-sm-12 col-md-12 col-xs-12 superCharge text-center noPad">
                        <div class="Online_Experts">
                            <h2 style="font-size: 24px;color: #000;"> Are You Interested?</h2>
                            <p><i class="fa fa-hand-o-right text-primary" ></i> Get Ready for Free Consulation & Audit from our Online Experts Now!</p>
                            <p><i class="fa fa-hand-o-right  text-primary" ></i> Discover how we can help you boost your organic rankings.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="how_it_work1">
                            ...
                            <ul>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Choose the plan that suits you best and submit your order.</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> We will review your website in the next 24 hours and share some questions.</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Over the next few days, you'll receive a full audit with a customized, actionable plan for your website.</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> Start working on your website and get the help you need.</li>
                                <li><i class="fa fa-hand-o-right text-primary" ></i> See your traffic and rankings increase!</li>
                            </ul>
                        </div>
                    </div>
                </div>
