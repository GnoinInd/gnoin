        ...
        <section class="inner-banner">
            <div class="container">
                <div class="inner-banner__content-wrap">
                    <h2 class="inner-banner__title">Our Team</h2>
        ...
        <section class="team-two">
            <div class="container">
                <div class="block-title text-center">
                    <h2 class="block-title__title">Our leadership <br>
                        <span>experts</span></h2><!-- /.block-title__title -->
                    <p class="block-title__text">Dolor sit amet consectetur elit sed eiusmod tempor incididunt labore et <br>
                        dolore magna aliqua enim minim veniam quis nostrud exercitation ullamco. <br>
                        laboris aliquip commodo consequat.</p><!-- /.block-title__text -->
                </div><!-- /.block-title -->
                <div class="row high-gutters">
                    <div class="col-lg-4">
                        <div class="team-two__single">
                            <div class="team-two__images">
                                <img src="images/team/team-2-1.jpg" alt="">
                            ...
                            <div class="team-two__content">
                                <h3 class="team-two__name"><a href="#">Pearl Hernandez</a></h3><!-- /.team-two__name -->
                                <p class="team-two__designation">Team Leader</p><!-- /.team-two__designation -->
                    ...
                    <div class="col-lg-4">
                        <div class="team-two__single">
                            <div class="team-two__images">
                                <img src="images/team/team-2-2.jpg" alt="">
                                <div class="team-two__social">
                                    <a href="#"><i class="fa fa-facebook-f"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-vimeo"></i></a>
                            ...
                            <div class="team-two__content">
                                <h3 class="team-two__name"><a href="#">Christopher Owens</a></h3><!-- /.team-two__name -->
                                <p class="team-two__designation">Web Developer</p><!-- /.team-two__designation -->
                            </div><!-- /.team-two__content -->
                        </div><!-- /.team-two__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4">
                        <div class="team-two__single">
                            <div class="team-two__images">
                                <img src="images/team/team-2-3.jpg" alt="">
                                <div class="team-two__social">
                                    <a href="#"><i class="fa fa-facebook-f"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-vimeo"></i></a>
                            ...
                            <div class="team-two__content">
                                <h3 class="team-two__name"><a href="#">Lewis Jenkins</a></h3><!-- /.team-two__name -->
                    ...
                    <div class="col-lg-4">
                        <div class="team-one__block">
                            <div class="block-title">
                                ...
                                <a href="#" class="thm-btn team-one__block-btn">Join Us</a><!-- /.thm-btn -->
                            </div><!-- /.block-title -->
                        </div><!-- /.tea4-one__block -->
                    </div><!-- /.col-lg-3 -->
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="team-one__single wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                            ...
                            <div class="team-one__content">
                                ...
                                <div class="team-one__designation">Frontend Developer</div><!-- /.team-one__designation -->
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="team-one__single wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="500ms">
                            ...
                            <div class="team-one__content">
                                ...
                                <div class="team-one__designation">Digital Marketing Head</div><!-- /.team-one__designation -->
                            </div><!-- /.team-one__content -->
                        </div><!-- /.team-one__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="team-one__single wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="0ms">
                            ...
                            <div class="team-one__content">
                                ...
                                <div class="team-one__designation">Backend Developer</div><!-- /.team-one__designation -->
                            </div><!-- /.team-one__content -->
                        </div><!-- /.team-one__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="team-one__single wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="500ms">
                            ...
                            <div class="team-one__content">
                                ...
                                <div class="team-one__designation">Ios Developer</div><!-- /.team-one__designation -->
                            </div><!-- /.team-one__content -->
                        </div><!-- /.team-one__single -->
                    </div><!-- /.col-lg-4 -->
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="team-one__single wow fadeInUp" data-wow-duration="1500ms" data-wow-delay="1000ms">
                            ...
                            <div class="team-one__content">
                                ...
                                <div class="team-one__designation">Android Developer</div><!-- /.team-one__designation -->
                            </div><!-- /.team-one__content -->
                        </div><!-- /.team-one__single -->
                    </div><!-- /.col-lg-4 -->
                </div><!-- /.row -->
