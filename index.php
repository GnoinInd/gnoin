                ...
                <div class="col-12  mt-3 ">
                    <div class="owl-carousel owl-carousel-1 owl-theme">
                        ...
                        <div class="item_1 position-relative">
                            <div class="rectangle_bg"></div>
                            <div class="indsutry_exp_section">
                                <p class="text-center font-weight-bold">Education & e-Learning</p>
                            </div>
                            <div class="overlay">
                        ...
                        <div class="item_3 position-relative">
                            ...
                            <div class="overlay">
                               ...
                               <div class="card_content_ind_exp">
                               <h5 class="text-center font-bold text-white">Industries</h5>
                                 <p class="text-white">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dolorem quasi, neque quia minima necessitatibus a laborum amet atque? Non, quis!</p>
            ...
            <!-- d-none d-sm-none d-lg-block d-xl-block -->
                ...
                <div class="card custom_card_design custom_card_design2 ">
                    <div class="card-body">
                        ...
                        <h6
                            class="card-subtitle card-subtitle_initial mb-2 text-body-secondary techno_leverage_subheading">
                            Perfect Blend Of
        ...
        <div class="container text-center justify-content-around pt-4" data-aos="fade-up">
            ...
            <div class="row g-0 mt-4" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-xl-7 col-md-6 slides  position-relative">
                    ...
                    <div class="slides-1 swiper mySwipe">
                        <div class="swiper-wrapper">
