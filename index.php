    ...
    <<header class="site-header site-header__header-two ">
        ...
        <section class="banner-one">
            <div class="banner-one__carousel owl-carousel owl-theme">
                <div class="item">
                    <div class="banner-one__single" style="background-image: url(images/imagesIndex/index_img1.png);">
                        <div class="container">
                            ...
                            <div class="col-lg-6 col-md-8">
                                <div class="banner-one__content ">
                                    ...
                                    <h3 class="banner-one__title banner-one__is-animated typing-heading">Join us to transform your dreams digitally!
                                    ...
                                    <a href="about-2.html" class="thm-btn banner-one__btn thm-btn1"> <span>Let's start
                                            talk</span> </a><!-- /.thm-btn -->
                ...
                <div class="item">
                    <div class="banner-one__single banner-one__slide-2"
                        style="background-image: url(images/imagesIndex/index_img2.png);">
                        <div class="container">

                            <div class="col-lg-7 col-md-8">
                                <div class="banner-one__content ">
                                    <h3 class="banner-one__title banner-one__is-animated typing-heading"> Building trust in interorganizational collaboration
                                    ...
                                    <div class="banner-one__btn-group">
                                        <a href="contact.html" class="thm-btn1 banner-one__btn banner-one__is-animated">
                                            <span>Free
                                                Consultation</span> </a><!-- /.thm-btn -->
                ...
                <div class="item">
                    <div class="banner-one__single banner-one__slide-3"
                        style="background-image: url(images/imagesIndex/index_img3.png);">
                        <div class="container">
                            ...
                            <div class="col-lg-6 col-md-8">
                                <div class="banner-one__content">
                                    ...
                                    <!-- /.banner-one__tag-line -->
                                    <h3 class="banner-one__title banner-one__is-animated typing-heading">We are the makers of awesome business process
                                       
                                    </h3><!-- /.banner-one__title -->
                                    <p class="banner-one__text">Turn Your idea into extraordinary, Web and
                                        Mobile Apps with Gnoin
                                    </p><!-- /.banner-one__text -->
                                    <a href="about.html" class="thm-btn1 banner-one__btn banner-one__is-animated">
                                        <span>Let's
                                            start talk</span> </a>
                                    <!-- /.thm-btn -->
                                </div><!-- /.banner-one__content -->
    ...
    document.getElementById("my_form").addEventListener("submit", function (e) {
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="about-one__content">
                            <div class="block-title">
                                ...
                                <!-- /.block-title__text -->
                                <a href="about.html" class="thm-btn about-one__btn"> <span>Read More</span> </a>
                            </div><!-- /.block-title -->
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="video-one wow fadeInRight" data-wow-duration="1500ms">
                            <img src="images/imagesIndex/indexImg1.png" alt="">
                            <a href="https:#" class="hvr-pulse video-one__link video-popup"><i
                                    class="fa fa-play"></i></a>

                        </div>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#0099ff" fill-opacity="1" d="M0,96L48,80C96,64,192,32,288,48C384,64,480,128,576,133.3C672,139,768,85,864,53.3C960,21,1056,11,1152,26.7C1248,43,1344,85,1392,106.7L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg>
                </div>
        ...
        <section class="cta-one">
            <div class="container text-center">
                <h3 class="cta-one__title typing-heading">We deliver Innovative, Reliable and creative services</h3>
            ...
            <div class="container">
                <div class="row no-gutters">
                    <div class="col-lg-6 clearfix">
                        <img src="images/imagesIndex/indexImg2.png" alt="" class="float-right">
                    </div><!-- /.col-lg-6 -->
                    ...
                    <div class="col-md-12">
                        <div class="row ">
                            <div class="col-md-4 mb-2 col-sm-6 col-xs-12 ">
                                <div class="delivery_models float-left">
                                    <div class="box_shad p-3">
                                        <img src="images/imagesIndex/websiteWebApp.png" alt="">
                            ...
                            <div class="col-md-4 mb-2 col-sm-6 col-xs-12">
                                <div class="delivery_models">
                                    <div class="box_shad p-3">
                                        <img src="images/imagesIndex/mobileAppDev.png" alt="">
                                        <h3>Mobile App Development</h3>
                                        <p class="para">mobile app development, We build an impressive mobile app that
                                            fits
                            ...
                            <div class="col-md-4 mb-2  col-sm-6 col-xs-12">
                                <div class="delivery_models">
                                    <div class="box_shad p-3">
                                        <img src="images/imagesIndex/businessBranding.png" alt="">
                                        <h3>Business Branding</h3>
                                        <p class="para">Hire end-to-end branding team with niche skills and heavy
                                            efficiency. <span><a href="#"><i class="fa fa-hand-o-right"></i></a></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-2 col-sm-6 col-xs-12">
                                <div class="delivery_models">
                                    <div class="box_shad p-3">
                                        ...
                                        <h3>UI/UX Design</h3>
                                        <p class="para">Creating beautiful UI/UX design that calls out to our client's
                                            exact
                                            vision and goals.<span><a href="/ux-desiner.html"><i
                                                        class="fa fa-hand-o-right"></i></a></span>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="delivery_models">
                                    <div class="box_shad p-3">
                                        ...
                                        <p class="para">Hire Software Testing team with niche skills and heavy
                                            efficiency.<span><a href="/Testing-&-QA-Services.html"><i
                            ...
                            <div class="col-md-4 mb-2  col-sm-6 col-xs-12">
                                <div class="delivery_models">
                                    <div class="box_shad p-3">
                                        ...
                                        <p class="para">Integrate third-party APIs for web, cloud, and mobile apps to
                                            extend
                                            your capabilities with all frameworks and technologies.<span><a
                                                    href="/api.html"><i class="fa fa-hand-o-right"></i></a></span></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4 mb-2 col-sm-6 col-xs-12">
                                <div class="delivery_models">
                                    <div class="box_shad p-3">
                                        <img src="images/imagesIndex/cloudDev.png" alt="">
                            ...
                            <div class="col-md-4 mb-2 col-sm-6 col-xs-12">
                                <div class="delivery_models">
                                    <div class="box_shad p-3">
                                        ...
                                        <p class="para">We recognize issues with presentation, compatibility, and
                                            obsolete
                                            plug-ins and data sources for the current state of the product.<span><a
                                                    href="/support-&-maintenace.html"><i
                                                        class="fa fa-hand-o-right"></i></a></span></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            <a class="thm-btn" href="#"> <span>Let's Discuss Your Project</span> </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="row  pading" id="industry">
                    <div class="col-md-12 col-lg-4" id="industry1-box">
                        <div class="ed_box_animado text-center">
                            <img class="w-25 ed_icon" src="images/imagesIndex/indusExp1.png" alt="">
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner row w-100 mx-auto">
                                <div class="carousel-item col-12 card active">
                                    ...
                                    <div class="card-body">
                                        <img class="card-img-top" src="images/imagesIndex/indusExp2.png"
                                            alt="Card image cap">
                    ...
                    <div class="col-md-12 col-lg-4 link p-4 " id="industry3-box">
                        <h4 class="mt-lg-0 mt-sm-3 border-bottom text-white ">Quick Links</h4>
                        <ul class="m-0 p-0 ">
                    ...
                    <div class="col-md-6 col-lg-3 card-container wow fadeInUp">
                        <div class=" card-flip">
                            ...
                            <div class="back card justify-content-center p-1 align-items-center card-block">
                                ...
                                <div class="card-body mt-2">
                                    <p class=" text-center">Provide advantages to clients in need of an extended team in
                    ...
                    <div class="col-md-6 col-lg-3 card-container wow fadeInUp">
                        <div class=" card-flip">
                            ...
                            <div class="back card justify-content-center p-1 align-items-center card-block">
                                ...
                                <div class="card-body mt-2">
                                    <p class=" text-center">Consolidation of onsite and offsite models for optimal
                    ...
                    <div class="col-md-6 col-lg-3 card-container wow fadeInUp">
                        <div class=" card-flip">
                            ...
                            <div class="back card justify-content-center p-1 align-items-center card-block">
                                ...
                                <div class="card-body mt-2">
                                    <p class=" text-center">Skilled team working onsite to develop product or solution
                                        at customer point.</p>
                                    <a href="#" class="btn btn-primary">Read More</a>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-3 card-container wow fadeInUp">
                        <div class=" card-flip">
                            ...
                            <div class="back card justify-content-center p-1 align-items-center card-block">
                                ...
                                <div class="card-body mt-2">
                                    <p class=" text-center"> We provides a complete software solution which you
                                        purchase/rent on a pay-as-you-go basis from a cloud service provider.</p>
                                    <a href="#" class="btn btn-primary">Read More</a>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-3 card-container wow fadeInUp">
                        <div class=" card-flip">
                            ...
                            <div class="back card justify-content-center p-1 align-items-center card-block">
                                ...
                                <div class="card-body mt-2">
                                    <p class=" text-center">Distributed control development process between offsite
                                        center and offshore development center.</p>
                                    <a href="#" class="btn btn-primary">Read More</a>
                                </div>
                        ...
                        <div class=" card-flip">
                            <div class="front card justify-content-center p-4 align-items-center card-block">
                                <div class="card-img-top w-50">
                                    ...
                                    <img src="images/imagesIndex/OurOrgDeliveryModel8.png" alt="...">
                                </div>
                                <div class="card-body text-center">
                            ...
                            <div class="back card justify-content-center p-1 align-items-center card-block">
                                ...
                                <div class="card-body mt-2">
                                    <p class=" text-center">Enables cross-functional teams to continuously improve the
                                        products, processes and people needed to deliver value to end users.</p>
                                    <a href="#" class="btn btn-primary">Read More</a>
                                </div>
            ...
            <div class="container text-center justify-content-around pt-4" data-aos="fade-up">
                ...
                <div class="row g-0" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-xl-5 col-md-6 img-bg">
                        <img src="images/imagesIndex/indexChooseUsImg.png">
                    </div>
        ...
        <footer class="site-footer">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="footer-widget">
                                ...
                                <p class="footer-widget__text">Gnoin Pvt. Ltd. is one of the fastest growing IT Services
                                    & IT Consulting Company providing end to end software solutions across the country.
                                    We provide IT expertise in Software, Website & Application (iOS & Android)
                                    Development, UI/UX Design and Digital Marketing. Our company focused on building
                                    innovative solutions that address customer's most complex digital transformation
                                    needs.</p>
                                <!-- /.footer-widget__text -->
            ...
            <div class="site-footer__bottom">
                <div class="container">
                    <div class="site-footer__copy">Gnoin Pvt Ltd <i class="fa fa-copyright"></i> 2023 All Right Reserved
                    </div>
